...
st.set_page_config(page_title="অনলাইন MCQ পরীক্ষা", page_icon="📝", layout="wide")
db.init_db()
...
.exam-running { color: #16a34a; font-weight: 700; font-size: 15px; }
.exam-not-running { color: #9ca3af; font-size: 13px; }
.timer-box {
    background: #111827; color: #fff; padding: 10px 20px; border-radius: 10px;
    font-size: 22px; font-weight: 700; text-align: center; display: inline-block;
}
.timer-warning { background: #b91c1c !important; }
.correct-answer { background: #dcfce7; padding: 6px 10px; border-radius: 6px; }
.wrong-answer { background: #fee2e2; padding: 6px 10px; border-radius: 6px; }
</style>
